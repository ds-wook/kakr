...
if __name__ == "__main__":
    ...
    parse.add_argument(
        "--path", type=str, help="Input data load path", default="../../data/"
    )

    parse.add_argument(
        "--submit", type=str, help="save the submit csv file", default="../../res/"
    )

    parse.add_argument(
        "--file", type=str, help="naming file name", default="submission.csv"
    )
    ...
    """
    y_preds = 0.65 * lgb_preds + 0.3 * xgb_preds + 0.05 * cat_preds
